...
1. Plot the MNIST sample data.

plot_digits(X_test)

2.Transform the input data to principal components using the pipeline.
...
3. Inverse transform the components back to the original feature space.
