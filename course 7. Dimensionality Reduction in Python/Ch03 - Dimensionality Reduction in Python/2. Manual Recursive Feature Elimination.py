...
1. First, run the given code, then remove the feature with the lowest model coefficient from X.
...
2. Run the code and remove 2 more features with the lowest model coefficients.
...
3. Run the code and only keep the feature with the highest coefficient.
